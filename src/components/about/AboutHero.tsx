  ...
  return (
    <section className="relative py-20 bg-neutral-900 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-32 right-16 w-24 h-24 border border-white rounded-full" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative overflow-hidden">
              ...
              <div className="absolute top-2 left-2 md:-top-6 md:-left-6 bg-white rounded-lg p-3 md:p-4 shadow-lg">
                <MapPin className="w-6 h-6 md:w-8 md:h-8 text-primary-500 mb-1 md:mb-2" />
                <div className="text-neutral-900 font-semibold text-sm md:text-base">50+ Destinations</div>
              </div>
              
              <div className="absolute bottom-2 right-2 md:-bottom-6 md:-right-6 bg-white rounded-lg p-3 md:p-4 shadow-lg">
                <Award className="w-6 h-6 md:w-8 md:h-8 text-secondary-500 mb-1 md:mb-2" />
                <div className="text-neutral-900 font-semibold text-sm md:text-base">Award Winning</div>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        >
          <div className="text-center">
            ...
            <p className="text-white/80">Passionate travel experts with deep destination knowledge</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-white/80">Every journey is crafted with your unique preferences in mind</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-white/80">Committed to excellence in every aspect of your travel experience</p>
          </div>
        </motion.div>
      </div>
    </section>
